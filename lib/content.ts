...
export async function getPortfolioContent(): Promise<PortfolioContent> {
  ...
  try {
    const [profile, stats, skills, services, projects, timeline, certifications, socialLinks] = await Promise.all([
    ...
    return { profile, stats, skills, services, projects, timeline, certifications, socialLinks } as PortfolioContent;
  } catch {
